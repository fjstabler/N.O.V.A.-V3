...
export const Requests = {
  ...
  AudioSourceAttach: 'audio.source.attach',
  AudioSourceDetach: 'audio.source.detach',
  AudioSourceFrame: 'audio.source.frame',
...
export const Topics = {
  ...
  RemotePlay: 'voice.remote.play',
  RemoteStop: 'voice.remote.stop',
  RemoteCapture: 'voice.remote.capture',
